        ...
        <div class="row">
            ...
            <div class="row primer-row">
                <div class="col-sm-4 col-md-6 centrado">
                    <ol>
                        <li>Cerro Fitz Roy</li>
                        <li>Laguna de los Tres</li>
                        <li>Volcan Lanin</li>
                        <li>Volcan Lanin</li>
                        <li>Volcan Tromen</li>
                        <li>Volcan Tromen</li>
                        <li>Appalachian Trail</li>
                        <li>Cerro Cocodrilo en Potrerillos</li>
                        <li>Cerro Arco</li>
                        <li>Cerro Dos Banderas</li>
                        <li>Cerro Carbajal</li>
                        <li>Sendero Cerro Corona</li>
                    </ol>
                </div>
